...
export default function CTASection() {
    return (
        <section className="relative w-full bg-black py-20 sm:py-28 md:py-36 lg:py-44 px-4 sm:px-6 lg:px-8 overflow-hidden">
            ...
            <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[600px] bg-[#8c52ff]/25 rounded-full blur-[150px]" />
            <div className="absolute bottom-0 right-1/4 w-[400px] h-[400px] bg-[#ff4080]/25 rounded-full blur-[120px]" />
            ...
            <div className="relative z-10 max-w-[1200px] mx-auto text-center">
                ...
                <motion.div
                    ...
                    viewport={{ once: true }}
                    className="inline-flex items-center gap-3 px-5 py-2.5 bg-white/5 border border-white/10 rounded-full mb-8"
                >
                ...
                >
                    ...
                    <Link
                        href="#"
                        className="bg-white/5 border border-white/20 text-white px-8 sm:px-12 py-4 sm:py-5 text-[13px] font-bold tracking-wider uppercase hover:bg-white/10 transition-all duration-300 w-full sm:w-auto text-center"
                    >
                        Join Discord
                    </Link>
                </motion.div>
