                ...
                <StaggerContainer className="max-w-5xl mx-auto text-center relative z-10">
                    <StaggerItem>
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 sm:gap-6 justify-center">
                            <Link href="/dev/docs" className="px-8 sm:px-10 py-4 sm:py-5 bg-[#ff4080] text-white font-black text-base sm:text-lg uppercase tracking-wider hover:bg-white hover:text-black transition-all duration-300 inline-flex items-center justify-center gap-3">
